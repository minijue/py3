...
class MannulFrame(wx.Frame):
    def __init__(self, superior, keys):
        ...
        self.label4 = wx.StaticText(panel, -1, u'请将成绩列表复制后粘贴至下列文本框：', pos=(30, 135))
        self.text = wx.TextCtrl(panel, -1, "", pos=(30, 160), size=(390, 70), style=wx.TE_MULTILINE)

        self.raido1 = wx.RadioButton(panel, -1, u'平时成绩', pos=(130, 235))
        self.raido2 = wx.RadioButton(panel, -1, u'考核成绩', pos=(230, 235))

        self.buttonOK = wx.Button(panel, -1, u"确定", pos=(130, 271))
        self.Bind(wx.EVT_BUTTON, self.onButtonOK, self.buttonOK)

        self.buttonCancel = wx.Button(panel, -1, u"取消", pos=(230, 271))
        self.Bind(wx.EVT_BUTTON, self.onButtonCancel, self.buttonCancel)
